...
{	(signed char) +1, -12*BLOW_UP, -9*BLOW_UP, // sync and move to y, x
	(signed char) +0, -6*BLOW_UP, +0*BLOW_UP, // additional sync move to y, x
	(signed char) -1, +2*BLOW_UP, +3*BLOW_UP, // draw, y, x
...
{	(signed char) +1, -12*BLOW_UP, -5*BLOW_UP, // sync and move to y, x
	(signed char) +0, -6*BLOW_UP, +0*BLOW_UP, // additional sync move to y, x
	(signed char) -1, +1*BLOW_UP, +2*BLOW_UP, // draw, y, x
	(signed char) -1, +11*BLOW_UP, +1*BLOW_UP, // draw, y, x
	(signed char) -1, +6*BLOW_UP, +0*BLOW_UP, // draw, y, x
...
{	(signed char) +1, -12*BLOW_UP, -12*BLOW_UP, // sync and move to y, x
